	...
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			*/	
            ...
            $data['menus'][] = array(
                'id'       => 'menu-events-calendar',
                'icon'	   => 'fa-calendar',
                'name'	   => $this->language->get('Календарь событий'),//не импортируется по ключу из файлов модуля, поставил готовый текст, если будет время вернуть к этому моменту
